...
import lk.ijse.project_01.bo.Custom.Impl.FoodBeverageAddBOImpl;
import java.sql.SQLException;
import java.util.List;

public class FoodBeverageAddPageController {

    @FXML private TableView<AddFoodbevarge> tblFoodBeverage;
    @FXML private TableColumn<AddFoodbevarge, String> colItemId;
    @FXML private TableColumn<AddFoodbevarge, String> colItemName;
    @FXML private TableColumn<AddFoodbevarge, String> colCategory;
    @FXML private TableColumn<AddFoodbevarge, Double> colPrice;

    @FXML private TextField txtItemId;
    @FXML private TextField txtName;
    @FXML private JFXComboBox<String> cmbCategory;
    ...
    private final FoodBeverageAddBO bo = new FoodBeverageAddBOImpl();
    ...
    private void generateItemId() {
        ...
        try {
            String lastId = bo.getLastItemIdByPrefix(prefix);
    ...
    private void loadAllItems() {
        try {
            List<AddFoodbevarge> items = bo.getAllItems();
    ...
    private void btnUpdateOnAction(ActionEvent actionEvent) {
        ...
        try {
            boolean updated = bo.updateItem(item);
            if (updated) {
    ...
    private void btnDeleteOnAction(ActionEvent actionEvent) {
        ...
        try {
            boolean deleted = bo.deleteItem(id);
            if (deleted) {
