...
public class FBOderPageController {
    ...
    private final FoodOrderBO bo = new FoodOrderBOImpl();
    ...
    private void loadFoodDataFromDatabase() {
        try {
            Map<String, List<FoodItem>> foodMap = bo.getAllFoodItemsGroupedByCategory();
            categoryItems.clear();
    ...
    private void loadGuest() {
        ...
        try {
            ...
            String name = bo.getGuestNameByPhone(phone);
    ...
    void btnAddToCartOnAction() {
        ...
        double price = categoryItems.get(category).stream()
    ...
    void btnConfirmOrderOnAction() {
        ...
        try {
            boolean success = bo.saveFoodOrder(phone, orderList);
