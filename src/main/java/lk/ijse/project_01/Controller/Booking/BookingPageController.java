...
public class BookingPageController {
    ...
    private void loadGuestName(String phoneNo) throws SQLException {
        ...
        String name = bookingBO.getGuestNameByPhone(phoneNo);
    ...
    private void loadAvailableRoomIds() throws SQLException {
        ...
        List<String> availableRooms = bookingBO.getAvailableRooms(roomType, checkIn, duration);
    ...
    void btnBookOnAction(ActionEvent event) {
        try {
            if (validateInput()) {
                ...
                boolean booked = bookingBO.bookRoom(dto);
    ...
    private String generateBookingId() {
        try {
            String lastId = bookingBO.getLastBookingId();
...

            {
                btn.setOnAction(event -> {
                    ...
                    if (booking.getStatus().equalsIgnoreCase("Confirmed")) {
                        ...
                        if (confirm) {
                            try {
                                boolean cancelled = bookingBO.cancelBooking(booking.getBookingId());
                                if (cancelled) {
                                    loadAllBookings();
