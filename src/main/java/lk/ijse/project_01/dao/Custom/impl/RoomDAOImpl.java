...
public class RoomDAOImpl implements RoomDAO {
    ...
    @Override
    public int getAvailableRoomCount(Connection con, String roomType) throws SQLException {
    ...
    @Override
    public String getAvailableRoomId(Connection con, String roomType) throws SQLException {
    ...
    @Override
    public boolean bookRoomById(Connection con, String roomId) throws SQLException {
    ...
    @Override
    public boolean releaseRoomById(Connection con, String roomId) throws SQLException {
        String roomType = getRoomTypeById(con, roomId);
        if (roomType == null) return false;
    ...
    private String getRoomTypeById(Connection con, String roomId) throws SQLException {
